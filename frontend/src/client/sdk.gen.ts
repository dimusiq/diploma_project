...
import type {
  ...
  DashboardGetDashboardStatsResponse,
  ItemsCreateItemData,
  ItemsCreateItemResponse,
  ItemsDeleteItemData,
  ItemsDeleteItemResponse,
  ItemsReadItemData,
  ItemsReadItemHistoryData,
  ItemsReadItemHistoryResponse,
...
export class ItemsService {
   ...
   * @throws ApiError
   */
  public static readItemHistory(
    data: ItemsReadItemHistoryData,
  ): CancelablePromise<ItemsReadItemHistoryResponse> {
    return __request(OpenAPI, {
      method: "GET",
